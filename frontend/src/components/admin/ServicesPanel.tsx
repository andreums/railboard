    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex gap-2">
                <button
                    onClick={() => setEditingService({ number: "", operator_id: null, train_type_id: null, origin_place_id: null, destination_place_id: null })}
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-blue-700/50">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                setEditingService({ ...editingService, notes: e.target.value })
                            }
                            className="col-span-2 px-3 py-2 bg-black/40 border border-white/10 rounded text-white"
                            rows={2}
                        />
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-white/10">
                    ...
                    <div className="space-y-2 mb-6">
                        {stops.map((stop) => (
                            <div
                                key={stop.id}
                                className="bg-black/30 p-4 rounded border border-white/10 flex justify-between items-center"
                            >
                                <div className="flex-1">
                                    <div className="font-bold text-white">{stop.stop_number}. {stop.station_name}</div>
                                    <div className="text-sm text-slate-300">
                    ...
                    <div className="bg-black/30 p-4 rounded border border-blue-700/50">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <input
                                ...
                                onChange={(e) =>
                                    setNewStop({ ...newStop, station_id: Number(e.target.value) })
                                }
                                className="px-3 py-2 bg-black/40 border border-white/10 rounded text-white"
                            />
                            <select
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewStop({ ...newStop, platform: e.target.value })
                                }
                                className="px-3 py-2 bg-black/40 border border-white/10 rounded text-white"
                            />
                            <input
                                ...
                                onChange={(e) =>
                                    setNewStop({ ...newStop, sector: e.target.value })
                                }
                                className="px-3 py-2 bg-black/40 border border-white/10 rounded text-white"
                            />
                        </div>
