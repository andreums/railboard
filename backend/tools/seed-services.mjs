...
const stops1 = [
  {
    station_id: getMadridStation().id,
    stop_number: 1,
    stop_type: "Origin",
    arrival_scheduled: "08:00",
    departure_scheduled: "08:00",
    platform: "1",
    sector: "A",
  },
  {
    station_id: getBarcelonaStation().id,
    stop_number: 2,
    stop_type: "Destination",
    arrival_scheduled: "11:30",
...
const stops2 = [
  {
    ...
    stop_number: 1,
    stop_type: "Origin",
    arrival_scheduled: "09:00",
    departure_scheduled: "09:00",
    platform: "7",
    sector: "C",
  },
  {
    ...
    stop_number: 2,
    stop_type: "Stop",
    arrival_scheduled: "09:15",
    departure_scheduled: "09:20",
    platform: "7",
    sector: "C",
  },
  {
    station_id: getValenciaStation().id,
    stop_number: 3,
    stop_type: "Destination",
    arrival_scheduled: "12:45",
    departure_scheduled: null,
    platform: "3",
    sector: "A",
  },
...
const stops3 = [
  {
    ...
    stop_number: 1,
    stop_type: "Origin",
    arrival_scheduled: "06:30",
    departure_scheduled: "06:30",
    platform: "2",
    sector: "B",
  },
  {
