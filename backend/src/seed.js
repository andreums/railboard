...
operators.create({ name: "Renfe", logo_url: null });
operators.create({ name: "Avlo", logo_url: null });
operators.create({ name: "Iryo", logo_url: null });
operators.create({ name: "Ouigo", logo_url: null });

trainTypes.create({ code: "AVE",   name: "Alta Velocidad",  color: "#7c1d2e" });
trainTypes.create({ code: "AVLO",  name: "Avlo",            color: "#5b1fb8" });
trainTypes.create({ code: "ALVIA", name: "Alvia",           color: "#1f6fb2" });
trainTypes.create({ code: "IC",    name: "Intercity",       color: "#2b6e3f" });
trainTypes.create({ code: "MD",    name: "Media Distancia", color: "#b25a1f" });
trainTypes.create({ code: "C",     name: "Cercanías",       color: "#c2185b" });
